...
public class CommandRegistryWorkflow {
    ...
    private static final List<CommandDef> DEFAULT_COMMANDS = List.of(
            ...
            new CommandDef("cmd.tabs_next", "Next Tab"),
            new CommandDef("cmd.tabs_prev", "Previous Tab"),
            new CommandDef("cmd.tabs_close_current", "Close Current Tab"),
            new CommandDef("cmd.tabs_close_others", "Close Other Tabs"),
            new CommandDef("cmd.tabs_close_all", "Close All Tabs"),
            new CommandDef("cmd.graph_open", "Open Graph"),
            new CommandDef("cmd.graph_refresh", "Refresh Graph"),
            new CommandDef("cmd.links_reindex", "Reindex Links"),
